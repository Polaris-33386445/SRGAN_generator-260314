...
# train images folder
train_HR_folder = '../DIV2K_train_HR'
train_LR_folder = '../DIV2K_train_LR_bicubic/X4'
# valid images folder
valid_HR_folder = '../DIV2K_valid_HR'
valid_LR_folder = '../DIV2K_valid_LR_bicubic/X4'
# test images folder
test_Set5_HR_folder = '../benchmark/Set5/HR'
test_Set5_LR_folder = '../benchmark/Set5/LR_bicubic/X4'
test_Set14_HR_folder = '../benchmark/Set14/HR'
test_Set14_LR_folder = '../benchmark/Set14/LR_bicubic/X4'
test_B100_HR_folder = '../benchmark/B100/HR'
test_B100_LR_folder = '../benchmark/B100/LR_bicubic/X4'
test_Urban100_HR_folder = '../benchmark/Urban100/HR'
test_Urban100_LR_folder = '../benchmark/Urban100/LR_bicubic/X4'
